        ...
        <section id="ai-innovation" className="relative py-24 md:py-32 overflow-hidden bg-background">
            ...
            <div className="container-custom relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-20">
                    {aiFeatures.map(({ title, desc, Icon, stat, label }) => (
                        <div
                            key={title}
                            ...
                            <div className="relative z-10">
                                <div className="flex items-center justify-between mb-8">
                                    ...
                                    <div className="text-right">
                                        <div className="text-xl font-black text-accent">{stat}</div>
                                        <div className="text-[9px] font-bold uppercase tracking-tight text-foreground/40">{label}</div>
                                    </div>
                                </div>
