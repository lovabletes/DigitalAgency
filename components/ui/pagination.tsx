...
import { ChevronLeftIcon, ChevronRightIcon, MoreHorizontalIcon } from "@/components/icons/icons"
...
function PaginationPrevious({
  ...
  return (
    <PaginationLink
      ...
      size="default"
      className={classNames("gap-1 px-2.5 sm:pl-2.5", className)}
      {...props}
    >
      <ChevronLeftIcon />
...
function PaginationNext({
  ...
  return (
    <PaginationLink
      ...
      size="default"
      className={classNames("gap-1 px-2.5 sm:pr-2.5", className)}
      {...props}
    >
